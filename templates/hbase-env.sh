...
export HBASE_MASTER_OPTS="$HBASE_MASTER_OPTS $HBASE_JMX_BASE -Dcom.sun.management.jmxremote.port=10101 -javaagent:{{ hbase_distr_prefix }}-{{ env_name }}-{{ hbase_version }}/lib/jmx_prometheus_javaagent-0.3.1.jar=9120:$HBASE_HOME/conf/jmx_prometheus_javaagent.yaml"
